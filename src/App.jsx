...
const Button = ({ children, variant = "gold", className = "", onClick }) => {
  const base =
    "inline-flex items-center justify-center gap-2 rounded-full px-7 py-4 text-sm font-semibold uppercase tracking-[0.16em] transition duration-300";
  const styles =
    variant === "gold"
...
export default function BarceloFontWebsite() {
  ...
  return (
    <div className="min-h-screen bg-[#f6f1e8] text-[#09192d] antialiased">
      {selectedService && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-[#061426]/80 px-4 backdrop-blur-sm"
        ...
        >
          ...
          >
            <button
              type="button"
              onClick={() => setSelectedService(null)}
              className="absolute right-6 top-6 rounded-full bg-[#071a2f] p-2 text-white hover:bg-[#d4af37] hover:text-[#071a2f]"
              aria-label="Cerrar"
            >
              <X size={20} />
            </button>
            ...
            <p className="mb-3 text-sm font-semibold uppercase tracking-[0.3em] text-[#b08d2c]">
              Área de especialización
            </p>
            <h2 className="font-serif text-4xl font-semibold md:text-5xl">
              {selectedService.title}
            </h2>
            <p className="mt-6 text-xl leading-relaxed text-[#4d5868]">
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              {selectedService.points.map((point) => (
                <div
                  key={point}
                  className="flex items-center gap-3 rounded-2xl bg-[#f6f1e8] p-4 text-[#09192d]"
                >
            ...
            <div className="mt-10 rounded-3xl bg-[#071a2f] p-6 text-white">
              <p className="font-serif text-2xl text-[#d4af37]">
                ¿Quiere analizar su caso?
              </p>
              <p className="mt-3 text-white/80">
                Contacte con nosotros y estudiaremos la mejor alternativa.
              </p>
              <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                <a
                  href="tel:630104856"
                  className="rounded-full bg-[#d4af37] px-5 py-3 text-center font-semibold text-[#071a2f]"
                >
                  Llamar ahora
                </a>
                <a
                  href="mailto:asociados@barcelo-font.com"
                  className="rounded-full border border-white/25 px-5 py-3 text-center font-semibold text-white"
                >
                  Enviar email
                </a>
              </div>
      ...
      <header className="relative min-h-screen overflow-hidden bg-[#061426] text-white">
        ...
        <nav className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div className="font-serif text-3xl font-semibold tracking-[0.22em]">
          ...
          <div className="hidden items-center gap-9 text-xs font-semibold uppercase tracking-[0.24em] text-white/75 md:flex">
            <a className="hover:text-[#d4af37]" href="#servicios">
              Servicios
            </a>
            <a className="hover:text-[#d4af37]" href="#metodo">
              Método
            </a>
            <a className="hover:text-[#d4af37]" href="#contacto">
              Contacto
            </a>
          </div>
          ...
          <div className="hidden items-center gap-3 md:flex">
            <a
              href="tel:630104856"
              className="group flex items-center gap-3 rounded-full bg-[#d4af37] px-7 py-4 text-base font-bold text-[#071a2f] shadow-[0_20px_50px_rgba(212,175,55,0.35)] transition hover:-translate-y-1 hover:scale-105 hover:bg-[#f0c95a]"
            >
              <Phone size={20} /> LLAMAR AHORA · 630 104 856
            </a>
          </div>
        </nav>
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl items-center gap-12 px-6 pb-24 pt-8 md:grid-cols-[1.1fr_0.9fr] md:pb-32 md:pt-12">
          ...
          >
            <p className="mb-6 text-sm font-semibold uppercase tracking-[0.35em] text-[#d4af37]">
              Soluciones inmobiliarias · patrimonio · laboral
            </p>
            <div className="mb-6 font-serif text-8xl font-bold leading-none md:text-[10rem]">
              <span className="text-white drop-shadow-2xl">B</span>
              <span className="text-[#d4af37] drop-shadow-2xl">F</span>
            </div>
            <h1 className="max-w-4xl font-serif text-5xl font-semibold leading-[0.95] tracking-tight md:text-7xl lg:text-8xl">
              Barceló & Font Asociados
            </h1>
            <p className="mt-8 max-w-2xl text-2xl leading-relaxed text-white/88 md:text-3xl">
              Convertimos situaciones complejas en soluciones claras, discretas y eficaces.
            </p>
          ...
          >
            <div className="rounded-[2rem] border border-white/15 bg-white/10 p-8 shadow-2xl backdrop-blur-xl">
              ...
              <p className="mt-5 text-lg leading-relaxed text-white/82">
                Para herencias, nuda propiedad, usufructo, subastas, deudas,
                finanzas y protección laboral.
              </p>
              ...
              <div className="mt-9 rounded-2xl border border-[#d4af37]/30 bg-[#061426]/70 p-6 text-white/90">
                <div className="flex flex-col items-start gap-3">
                  <span className="text-xs uppercase tracking-[0.25em] text-[#d4af37]">
                    Contacto directo
                  </span>
                  <div className="flex items-center gap-3 text-2xl font-bold">
                    <Phone size={20} className="text-[#d4af37]" /> 630 104 856
                  </div>
                </div>
                <div className="mt-4 flex items-center gap-3 text-white/80">
                  <Mail size={18} className="text-[#d4af37]" />
                  asociados@barcelo-font.com
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <main>
        <section
          id="servicios"
          className="relative overflow-hidden bg-[#f6f1e8] px-6 py-24 md:py-32"
        >
          ...
          <div className="pointer-events-none absolute bottom-0 right-0 top-0 hidden w-[42%] overflow-hidden lg:block">
            <div className="absolute inset-0 scale-105 bg-[url('https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=1400&q=90')] bg-cover bg-center" />
            ...
            <div className="absolute bottom-14 left-10 top-14 w-px bg-[#d4af37]/60" />
          </div>

          <div className="pointer-events-none absolute -left-28 top-24 h-72 w-72 rounded-full border border-[#d4af37]/25" />
          <div className="pointer-events-none absolute bottom-20 left-10 h-40 w-40 rounded-full border border-[#071a2f]/10" />

          <div className="relative mx-auto max-w-7xl lg:pr-[36%]">
            <div className="mb-16 max-w-4xl">
              <p className="mb-4 text-sm font-semibold uppercase tracking-[0.35em] text-[#b08d2c]">
                Servicios
              </p>
              <h2 className="font-serif text-5xl font-semibold leading-tight md:text-7xl">
                Áreas de especialización
              </h2>
              <p className="mt-6 max-w-3xl text-xl leading-relaxed text-[#4d5868]">
                Soluciones con criterio jurídico, visión práctica y orientación a
                resultados. Haga clic en cada área para ampliar información.
              </p>
            </div>
              ...
              {services.map((service, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mb-7 flex h-16 w-16 items-center justify-center rounded-full bg-[#071a2f] text-[#d4af37] transition group-hover:scale-110">
                      <Icon size={31} />
                    </div>
                    <h3 className="font-serif text-3xl leading-tight">
                      {service.title}
                    </h3>
                    <p className="mt-5 text-[1.03rem] leading-relaxed text-[#4d5868]">
                      {service.text}
                    </p>
                    <div className="mt-7 inline-flex items-center gap-2 text-sm font-bold uppercase tracking-[0.16em] text-[#b08d2c]">
        ...
        <section
          id="metodo"
          className="relative overflow-hidden bg-[#071a2f] px-6 py-24 text-white md:py-32"
        >
          <div
          ...
          <div className="relative mx-auto grid max-w-7xl gap-14 md:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className="grid gap-5 sm:grid-cols-3">
              {["Análisis", "Estrategia", "Ejecución"].map((step, i) => (
                <div
                  key={step}
                  className="rounded-3xl border border-white/10 bg-white/10 p-7 backdrop-blur"
                >
                  <p className="font-serif text-5xl text-[#d4af37]">0{i + 1}</p>
                  <h3 className="mt-8 font-serif text-2xl">{step}</h3>
                  <p className="mt-4 text-white/72">
                    Un proceso claro, sin rodeos y centrado en proteger sus intereses.
                  </p>
                </div>
              ))}
            </div>
        ...
        <section className="px-6 py-24 md:py-32">
          <div className="mx-auto max-w-7xl rounded-[2.5rem] bg-white p-8 shadow-[0_30px_100px_rgba(9,25,45,0.12)] md:p-14">
            <div className="grid gap-12 md:grid-cols-2">
              <div>
                ...
                <h2 className="font-serif text-5xl font-semibold leading-tight md:text-6xl">
                  Experiencia, discreción y soluciones reales
                </h2>
              </div>
              <div className="space-y-6 text-lg leading-relaxed text-[#4d5868]">
                <p>
                  Barceló & Font Asociados acompaña a personas y familias en
                  decisiones importantes cuando existen deudas, conflictos
                  patrimoniales, herencias, subastas o problemas laborales.
                </p>
                <p>
                  Nuestro objetivo es ofrecer una respuesta clara, profesional y
                  orientada a resultados, evitando tecnicismos innecesarios y
                  buscando siempre la vía más eficaz.
                </p>
              </div>
            </div>
          </div>
        ...
        <section
          id="contacto"
          className="relative overflow-hidden bg-[#061426] px-6 py-24 text-white md:py-32"
        >
          ...
          <div className="relative mx-auto max-w-6xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-xl leading-relaxed text-white/78">
              Cuéntenos su situación y analizaremos la mejor alternativa para
            ...
            <div className="mx-auto mt-12 grid max-w-4xl gap-5 md:grid-cols-3">
              <a
                href="tel:630104856"
                className="rounded-3xl border border-[#d4af37]/40 bg-gradient-to-br from-[#d4af37] to-[#f0c95a] p-8 text-[#071a2f] shadow-[0_20px_60px_rgba(212,175,55,0.35)] transition hover:scale-105"
              >
                <Phone className="mx-auto" />
                <p className="mt-4 font-serif text-xl">Teléfono</p>
                <p className="mt-2 text-2xl font-bold">630 104 856</p>
              </a>

              <a
                href="mailto:asociados@barcelo-font.com"
                className="rounded-3xl border border-white/10 bg-white/10 p-7 backdrop-blur hover:bg-white/15"
              >
                <Mail className="mx-auto text-[#d4af37]" />
                <p className="mt-4 font-serif text-xl">Email</p>
                <p className="mt-2 text-white/75">asociados@barcelo-font.com</p>
              </a>

              <div className="rounded-3xl border border-white/10 bg-white/10 p-7 backdrop-blur">
                <Globe className="mx-auto text-[#d4af37]" />
                <p className="mt-4 font-serif text-xl">Web</p>
                <p className="mt-2 text-white/75">barcelo-font.com</p>
              </div>
            </div>
          </div>
        </section>
